...
# Create a folder to store the prescriptions if not exists
...
# Function to create prescription PNG
# Updated Function to create prescription PNG
def create_prescription(patient_name, age, medicines, syrups, dosages, syrup_dosages, frequencies, syrup_frequencies, durations, syrup_durations, doctor, filename):
    # Create an image
    ...
    # Save the image
    img.save(f'prescriptions/{filename}.png')
...
def generate_random_prescriptions(num_samples):
    for i in range(1, num_samples + 1):
        ...
        # Create and save prescription PNG
        create_prescription(patient_name, age, medicines, syrups, dosages, syrup_dosages, frequencies, syrup_frequencies, durations, syrup_durations, doctor, filename)
...
if __name__ == "__main__":
    ...
    print(f"{num_images} prescriptions generated successfully in the 'prescriptions' folder!")
